...
const WillForm = () => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const periodInSeconds = parseInt(inactivityPeriod)
    ...
    try {
      ...
      if (demoMode) {
        ...
        setTimeout(async () => {
          ...
          // Update local balance immediately after transfer
          setUserBalance('0');
          
          // Also update localStorage
          const currentData = JSON.parse(localStorage.getItem(`will_${account}`) || '{}');
          localStorage.setItem(`will_${account}`, JSON.stringify({
            ...currentData,
            balance: '0'
          }));
